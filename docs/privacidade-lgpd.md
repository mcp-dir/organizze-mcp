...
Organizze segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Organizze** | BR | personal finance platform + oauth + mcp |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [organizze@mcp.ai](mailto:organizze@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
